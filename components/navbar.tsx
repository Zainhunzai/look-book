          ...
          <div className="fixed left-0 top-0 h-full w-full bg-white z-50 lg:hidden shadow-2xl transform transition-transform duration-300 ease-in-out">
            <div className="flex flex-col h-full p-4 w-full">
              ...
              <div className="flex justify-between items-start mb-8 pt-4">
                <Image src="/logo.svg" alt="Look&book" width={133} height={24} className="w-33 h-auto" />
                <button
              ...
              <nav className="flex flex-col space-y-6">
                <a
                  href="/"
                  className="text-lg text-neutral-600 font-normal leading-5 font-dm-sans hover:text-purple-600 transition-colors"
                  onClick={() => setIsMenuOpen(false)}
                >
                  Home
                </a>
              ...
              <div className="flex flex-col text-left space-y-5 lg:space-y-5 border-t pt-10">
                <a
                  href="#"
              ...
              <p className="block md:hidden text-base py-8 text-neutral-600 font-onest font-normal leading-normal sm:leading-relaxed">
